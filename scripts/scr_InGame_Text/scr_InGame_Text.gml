...
function scr_game_text(_text_id) { //("<" = Color) ("<~" = Wavy) ("<^" = Shake)
	...
	switch(_text_id) {
		...
		#region /////--------MIND--------/////
			...
			#region ///-----Eggman-----///
				case "Pre-Egg":
					scr_text(scr_DialogueText("egg_Pre"), "false", ["No One"]);
				break;
			
				case "Eggman":
					scr_text(scr_DialogueText("egg_Man1-1"), "false", ["No One"]);
					scr_text(scr_DialogueText("egg_Man1-2"), "false", ["No One"]);
						scr_option(scr_LocalText("opt_Yes"), "Egg-Yes");
						scr_option(scr_LocalText("opt_No"), "Egg-No");
						
					obj_TextboxColl.text_id = "Lost-Egg";
					instance_destroy(inst_6B8D5D7F);
				break;
				
				case "Egg-Yes":
					scr_text(scr_DialogueText("egg_Man2-1A"), "false", ["No One"]);
					scr_text(scr_DialogueText("egg_Man2-2A"), "false", ["No One"]);
					scr_text(scr_DialogueText("egg_Man2-3A"), "false", ["No One"]);
				break;
				
				case "Egg-No":
					scr_text(scr_DialogueText("egg_Man2-1B"), "false", ["No One"]);
				break;
				
				case "Lost-Egg":
					scr_text(scr_DialogueText("egg_Man3-1"), "false", ["No One"]);
				break;
			#endregion
		#endregion
