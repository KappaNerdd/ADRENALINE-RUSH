...
if !global.SimplifyVFX {
	...
	if createThingTimer <= 0 {
		...
		instance_create_depth(x, y, depth, obj_FreeplayGlow);
	}
}


if place_meeting(x, y, obj_TitleCursor) && jump_Key && !obj_FreeplaySpeedStages.speedStageActive && !obj_FreeplayActionStages.actionStageActive {
	image_xscale += 0.02;
	image_yscale += 0.02;
