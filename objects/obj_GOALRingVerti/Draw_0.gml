	...
	if goalTimer > 0 or image_speed != 0 {
		...
		draw_sprite_ext(_ringBack, image_index, x, y, image_xscale, image_yscale, 90, global.fullRGB, image_alpha);
		draw_sprite_ext(_ringBack, image_index, x, y, image_xscale, image_yscale, 90, c_white, 0.5);
	}

	if goalTimer > 0 {
		if global.Outline {
			gpu_set_fog(true, _col2, 0, 1);
				draw_sprite_ext(_spr4, 0, round(x) + _change2, round(y), image_xscale, image_yscale, 0, c_white, image_alpha);
				draw_sprite_ext(_spr4, 0, round(x) - _change2, round(y), image_xscale, image_yscale, 0, c_white, image_alpha);
				draw_sprite_ext(_spr4, 0, round(x), round(y) + _change2, image_xscale, image_yscale, 0, c_white, image_alpha);
				draw_sprite_ext(_spr4, 0, round(x), round(y) - _change2, image_xscale, image_yscale, 0, c_white, image_alpha);
			gpu_set_fog(false, c_black, 0, 1);
	...
	if goalTimer > 0 or image_speed != 0 {
		...
		draw_sprite_ext(_ringFront, image_index, x, y, image_xscale, image_yscale, 90, global.fullRGB, image_alpha);
		draw_sprite_ext(_ringFront, image_index, x, y, image_xscale, image_yscale, 90, c_white, 0.5);
		...
		draw_sprite_ext(_ringWhole, mindFrames, x, y, image_xscale, image_yscale, 90, global.fullRGB, image_alpha);
	
		if global.Outline {
			gpu_set_fog(true, _col2, 0, 1);
				draw_sprite_ext(_spr4, 1, round(x) + _change2, round(y), image_xscale, image_yscale, 0, c_white, image_alpha);
				draw_sprite_ext(_spr4, 1, round(x) - _change2, round(y), image_xscale, image_yscale, 0, c_white, image_alpha);
				draw_sprite_ext(_spr4, 1, round(x), round(y) + _change2, image_xscale, image_yscale, 0, c_white, image_alpha);
				draw_sprite_ext(_spr4, 1, round(x), round(y) - _change2, image_xscale, image_yscale, 0, c_white, image_alpha);
			gpu_set_fog(false, c_black, 0, 1);
