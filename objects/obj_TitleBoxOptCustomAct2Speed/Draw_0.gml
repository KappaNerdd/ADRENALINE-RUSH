...
if !changeBind {
	draw_text(x + 8, y + 4, scr_LocalText("opt_ConBoost"));
	...
	draw_sprite_ext(obj_CustomAct2KeySpeed.sprite_index, obj_CustomAct2KeySpeed.image_index, x - 80, y + 16, 1, 1, 0, _col, 1);
	
} else {
	draw_text(x + 8, y + 4, "ACTION 2");
}
