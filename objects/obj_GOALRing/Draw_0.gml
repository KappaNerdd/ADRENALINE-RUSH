	...
	if goalTimer > 0 or image_speed != 0 {
		...
		draw_sprite_ext(_ringBack, image_index, x, y, image_xscale, image_yscale, 0, c_white, 0.25);
	}

	if goalTimer > 0 {
		draw_sprite_ext(iconSprite, 0, x + 5, y + 5, image_xscale, image_yscale, 0, c_black, 0.5);
	...
	if goalTimer > 0 or image_speed != 0 {
		...
		draw_sprite_ext(_ringFront, image_index, x, y, image_xscale, image_yscale, 0, c_white, 0.25);
	} else if goalTimer <= 0 && image_speed == 0 {
		draw_sprite_ext(iconSprite, 1, x + 5, y + 5, image_xscale, image_yscale, 0, c_black, 0.5);
