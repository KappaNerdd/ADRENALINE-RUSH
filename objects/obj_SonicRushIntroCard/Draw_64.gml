...
draw_sprite_ext(_charCheck, global.PlayerCostume, -_xMove + spikeX + 350, -100, 0.5, 0.5, 0, c_white, otheralpha / 2);
draw_sprite_ext(obj_Player.sprite_index, obj_Player.image_index, charX + _relX, _relY, obj_Player.image_xscale * charScale, obj_Player.image_yscale * charScale, obj_Player.drawAngle, c_black, 1);
draw_sprite_ext(_char, 0, 300, 160, 1, 1, 0, c_white, otheralpha);
...
draw_sprite_ext(_spikes, spikeFrames, spikeX, -20, 2, 2, 0, global.fullRGB, otheralpha);
draw_sprite_ext(_spikes, spikeFrames, spikeX, -20, 2, 2, 0, c_black, otheralpha / 2);
draw_sprite_ext(_spikes, spikeFrames, spikeX, 0, 2, 2, 0, global.fullRGB, otheralpha);
...
draw_sprite_ext(spr_TextboxSonicRush, charBoxFrames, 384, charBoxY + 21, 25, 1, 0, c_black, otheralpha);
draw_sprite_ext(spr_TextboxSonicRush, charBoxFrames, 384, charBoxY + 16, 25, 1, 0, c_white, otheralpha);
		
draw_set_halign(fa_right);
	draw_text_transformed_color(charNameX, charBoxY + 4, scr_LocalText(_charName), 1, 1, 0, _col, _col, _col, _col, otheralpha);
	draw_text_transformed_color(charNameX + charNameXRepeat / 2, charBoxY + 4, scr_LocalText(_charName), 1, 1, 0, _col, _col, _col, _col, otheralpha);
	draw_text_transformed_color(charNameX + charNameXRepeat, charBoxY + 4, scr_LocalText(_charName), 1, 1, 0, _col, _col, _col, _col, otheralpha);
	draw_text_transformed_color(charNameX + charNameXRepeat * 1.5, charBoxY + 4, scr_LocalText(_charName), 1, 1, 0, _col, _col, _col, _col, otheralpha);
	draw_text_transformed_color(charNameX + charNameXRepeat * 2, charBoxY + 4, scr_LocalText(_charName), 1, 1, 0, _col, _col, _col, _col, otheralpha);
