...
#region //New
	...
	#region //Variables
		...
		if following != noone {
			_camX = floor((following.x + _changeX) - _camWidth / 2);
			_camY = floor((following.y + _changeY - 16) - _camHeight / 2);
		}
		...
		camera_set_view_size(view_camera[0], 512 * camX2, 288 * camY2);
		...
		camera_set_view_pos(view_camera[0], round(finalCamX), round(finalCamY));
