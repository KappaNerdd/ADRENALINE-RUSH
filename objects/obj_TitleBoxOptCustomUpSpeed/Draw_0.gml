...
if !changeBind {
	draw_text(x + 8, y + 4, scr_LocalText("opt_ConUp"));
	...
	draw_sprite_ext(obj_CustomUpKeySpeed.sprite_index, obj_CustomUpKeySpeed.image_index, x - 80, y + 16, 1, 1, 0, _col, 1);
	
} else {
	draw_text(x + 8, y + 4, "UP");
}
