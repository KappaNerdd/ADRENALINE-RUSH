...
if !changeBind {
	...
	if !gamepad_is_connected(global.Player1Con) {
		...
		if _var == global.LeftKeySpeed or _var == global.RightKeySpeed or _var == global.UpKeySpeed or _var == global.DownKeySpeed or _var == global.JumpKeySpeed or _var == global.Action1KeySpeed or _var == global.Action4KeySpeed or _var == global.ActionKeySpeed or _var == global.Action2KeySpeed or _var == global.Action3KeySpeed or _var == global.PauseKeySpeed {
			_col = c_red;
		}
	} else {
	...
	draw_sprite_ext(obj_CustomSelectKeySpeed.sprite_index, obj_CustomSelectKeySpeed.image_index, x + 200, y + 16, 1, 1, 0, _col, 1);
