...
if accept_Key {
	...
	switch(menu_Level) {
		...
		if cancel_Key {
			...
			//Main Menu
			case 4: menu_Level = 7; obj_SFXManager.menuConfirm = true; break;
			
			//Quit
			case 5: menu_Level = 8; obj_SFXManager.menuConfirm = true; break;
			...
			switch(pos) {
				...
				case 0:
					if global.PlayerExtraLives > 0 {
						...
						global.Death = false;
						global.DeathCountdown = 240;
						global.GameOverCountdown = 300;
