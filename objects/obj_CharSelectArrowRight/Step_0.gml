...
if (right_Key) && !global.ChooseCostume && pressed == false && !instance_exists(obj_CharSelectGirlyChoose) && obj_CharSelectWhiteBall.partner2Confirmed == false {
	pressed = true;
	...
	do {
        ...
        if (global.SelectedPlayer >= global.PlayerNum) {
...
if (!global.PlayerSelection[global.SelectedPlayer][1]) { //Skip unplayable characters
	global.SelectedPlayer += 1;
}
